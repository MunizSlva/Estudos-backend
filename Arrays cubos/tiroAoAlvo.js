...
let contadorDisparosBons = 0;

for (pontuacao of disparos) {
    if (pontuacao > 70) {
        contadorDisparosBons++;
    }
} if (contadorDisparosBons >= 3) {
    console.log(contadorDisparosBons);
} else {
...
// Numa competição de tiro ao alvo, cada competidor pode fazer uma certa quantidade de disparos. A cada disparo é atribuida uma pontuação que vai de 0 a 100.
